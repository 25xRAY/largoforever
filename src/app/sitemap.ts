...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: base + "/wall-of-wins", lastModified: new Date(), changeFrequency: "daily", priority: 0.9 },
    ...
    { url: base + "/leaderboards", lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
