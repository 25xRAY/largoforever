...
- **Graduation ceremony (post-ship):** `constants.ts` — May 17, 2026, 10:30 a.m., The Show Place Arena, Upper Marlboro, MD (`GRADUATION_DATE_ISO`, `GRADUATION_CEREMONY_SUMMARY`); homepage/dashboard countdowns, `DeadlinesWidget`, FAQ schema (`seo.ts`), help FAQ, Ed RonIQ system prompt.
